    ...
    >
      ...
      >
        <div
         ...
         justify-center bg-orange-100 px-4 py-1
          rounded-full"
        >
          <p
        ...
        <p
          className="text-[2.5rem] lg:text-[4.5rem] font-bold
        ...
        >
          ...
          fuga neque et aut rem repellat ad dolores ipsa numquam autem. Error
          libero deserunt in repudiandae ad autem facere excepturi illum saepe.
        </p>
        <button
          type="button"
          className="bg-gradient-to-br from-orange-400
           to-orange-500 w-auto md:w-auto px-4 py-2 
      ...
      <div className="py-2 flex-1 items-center relative">
        ...
        <div
         ...
         left-0 flex items-center drop-shadow-lg
        ...
        >
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
                className="lg:w-190 min-w-[190px] p-4 bg-cardOverlay
           ...
           items-center justify-center"
              >
                ...
                <p
                 ...
                 text-textColor lg:mt-4 mt-2"
                >
                  {n.name}
                </p>
                <p className="text-[12px] lg:text-sm text-lighttextGrey font-semibold my-1 lg:my-3">
                  {n.decp}
                </p>
